...
uvicorn app.main:app --host 127.0.0.1 --port 9000   # run the service (cp .env.example .env first)
```

Use `--host 127.0.0.1` unless you specifically accept exposing the dashboard
